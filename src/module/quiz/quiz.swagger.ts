 ...
 *    description: Allows a student to submit answers for a module quiz. A quiz can only be attempted once. Submission must occur within the quiz duration (e.g. 5 minutes).
 *    tags:
 *      - Student Quiz
 *    security:
 *      - bearerAuth: []
